...
class MessageList extends Component {
    ...
    render() {let content;
        ...
        return (
            <Container fluid className={"login-s1 align-items-start p-0 py-5 bg-info d-flex minh-100vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100 mt-5">
                    ...
                    <Col xs={12} md={9} className="mx-auto p-0 d-flex align-items-start p-3">
                        <Card className="w-100 minh-50vh bg-info border-light">
                            <Card.Body>
                                <p className="initialism text-light text-start border-bottom border-light mb-4">
                                    Messages
                                </p>
                                {content}
                            </Card.Body>
