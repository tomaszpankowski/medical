            ...
            <Container fluid className={"contact-s2 align-items-center p-0 py-5 border-top border-info d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={10} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Card className="mx-auto bg-dark opacity-9 border-light shadow">
                            <Card.Header className="text-light text-start border-light">
                                Message error!
                            </Card.Header>
                            <Card.Body className="text-center text-light p-5">
